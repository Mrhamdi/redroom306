    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('product_image', models.FileField(upload_to=redroomapp.models.product_image_path)),
                ('product_thumb', models.FileField(upload_to=redroomapp.models.product_thumb_path)),
            ],
        ),
        migrations.CreateModel(
            name='Invoice',
            fields=[
                ...
                ('product', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='redroomapp.product')),
            ],
        ),
    ]
